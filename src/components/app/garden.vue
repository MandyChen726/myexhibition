        ...
        <div style="padding: 24px">
                ...
                <n-flex vertical :size="24">
                    ...
                    <n-card>
                        <n-grid :x-gap="4" style="align-items: center;">
                            <n-gi :span="4">
                                <img style="width: 100%"
                                    :src="`./myexhibition/SunRiseGarden/app/garden/${curItem.type}.webp`" />
                            </n-gi>
            ...
            <n-modal :mask-closable="false" v-model:show="showCreateRedeemModal" class="custom-card" preset="card"
                ...
                <n-flex vertical :size="24">
                    <n-flex class="itemImg" :align="'center'" :justify="'center'">
                        <img style="width: 70%"
                            :src="`./myexhibition/SunRiseGarden/app/garden/${formModel.type === null ? 0 : formModel.type}.webp`" />
                    </n-flex>
            ...
            <n-grid class="itemContainer" :cols="2" :x-gap="24" :y-gap="24">
                <n-gi v-for="item in items">
                    <n-flex class="itemImg" :align="'center'" :justify="'center'">
                        <img :src="`./myexhibition/SunRiseGarden/app/garden/${item.type}.webp`"
                            :style="{ opacity: item.stock ? '1' : '0.4' }" />
                        <img v-if="!item.stock" class="soldoutImg"
                            :src="`./myexhibition/SunRiseGarden/app/garden/soldout.webp`" />
                    </n-flex>
