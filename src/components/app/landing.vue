    ...
    <div v-if="!stage" class="landingContainer">
        ...
        <n-flex class="userInput" :align="'center'">
            <n-flex style="width: 100%; margin-top: -128px" vertical :size="24">
                ...
                <div>
                    <n-input size="large" maxlength="4" :allow-input="onlyAllowNumber" v-model:value="familyID" round
                        placeholder="Enter your 4-digit family ID">
                        <template #prefix>
                            <n-icon>
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    viewBox="0 0 20 20">
                ...
                <n-button size="large" style="width: 100%" type="primary" round @click="handleContinue">
                    Continue
                </n-button>
                <n-flex :justify="'center'">
                    No family id?
                    <n-button text @click="handleCreateFamilyID">
    ...
    <div v-else class="landingContainer">
        ...
        <n-flex class="identityContainer" :align="'center'">
            <n-flex class="identityContainer__inner" vertical :size="24">
                ...
                <div class="identity" @click="identity = 1" :style="identity == 1 ? identitySelectStyle : undefined">
                    <div>
                        Parent
                    </div>
                </div>
                <div class="identity" @click="identity = 2" :style="identity == 2 ? identitySelectStyle : undefined">
                    <div>Child</div>
                </div>
